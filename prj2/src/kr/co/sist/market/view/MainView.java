...
public class MainView extends JFrame {
   ...
   private JLabel jlIdRst, jlSellRst,  jlPurchaseRst, jlNotReadMsgRst;
   ...
   public MainView(CustomerDAO cd) throws SQLException{
      ...
      ImageIcon iiInfo = new ImageIcon(System.getProperty("user.dir")+"/src/kr/co/sist/market/img/customer/"+imgName);
